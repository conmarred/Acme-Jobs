...
<acme:list readonly = "false">
	...
	<acme:list-column code="worker.application.list.label.job-reference" path="job.reference" width="20%"/>	
	<acme:list-column code="worker.application.list.label.username" path="username" width="20%"/>
</acme:list>
